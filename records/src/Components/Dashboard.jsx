  ...
  return (
    ...
    <div className="h-full min-h-screen w-full bg-gray-800 pt-12 p-4">
      <div className="grid gap-14 md:grid-cols-3 md:gap-5">
        <div className="rounded-xl bg-white p-6 text-center shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:cursor-pointer">
          <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-teal-400 shadow-lg shadow-teal-500/40 transition-all duration-300 hover:bg-teal-500 hover:shadow-teal-600/40">
          ...
          <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 transition-all duration-300 group-hover:text-teal-500">TREE AND SHRUB PRUNING</h1>
          <p className="px-4 text-gray-500 transition-all duration-300 hover:text-gray-600">
        ...
        <div className="rounded-xl bg-white p-6 text-center shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:cursor-pointer">
          <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-rose-500 shadow-lg shadow-rose-500/40 transition-all duration-300 hover:bg-rose-600 hover:shadow-rose-600/40">
          ...
          <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 transition-all duration-300 group-hover:text-rose-500">IRRIGATION & DRAINAGE</h1>
          <p className="px-4 text-gray-500 transition-all duration-300 hover:text-gray-600">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet modi
            accusantium vero perspiciatis, incidunt dicta sed aspernatur!
          </p>
        ...
        <div className="rounded-xl bg-white p-6 text-center shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:cursor-pointer">
          <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-sky-500 shadow-lg shadow-sky-500/40 transition-all duration-300 hover:bg-sky-600 hover:shadow-sky-600/40">
          ...
          <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 transition-all duration-300 group-hover:text-sky-500">GARDEN BED MAINTENANCE</h1>
          <p className="px-4 text-gray-500 transition-all duration-300 hover:text-gray-600">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet modi
            accusantium vero perspiciatis, incidunt dicta sed aspernatur!
          </p>
