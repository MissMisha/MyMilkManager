        ...
        >
          ...
          <div className="w-full mt-8">
            <div className="mx-auto max-w-xs sm:max-w-md md:max-w-lg flex flex-col gap-4">
              ...
              >
                <option value="" disabled selected >Select your Milk type</option>
                <option value="basic">Cow</option>
                <option value="premium">Buffalo</option>
                <option value="enterprise">Goat</option>
              </select>
